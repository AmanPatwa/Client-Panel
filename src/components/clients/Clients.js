            ...
            return (
                <div>
                    <div className="row">
                        ...
                        <div className="col-md-6">
                            <h5 className="text-secondary" style={{textAlign:'right'}}>
                                Total Owed{' '}
                                <span className="text-primary">
                                    ${parseFloat(this.state.totalBal).toFixed(2)}
                                </span>
                            </h5>
                        </div>
                    </div>
...
export default compose(
    firestoreConnect((props) => [
      { collection: 'clients' } // or `todos/${props.todoId}`
    ]),

...
class ClientDetails extends Component {
    ...
    balanceSubmit = e => {
        ...
        firestore.update({collection: 'clients', doc:client.id},{
            balance:parseFloat(this.state.balanceUpdateAmount)
        })
...
export default compose(
    firestoreConnect((props) => [
        { collection: 'clients', doc: props.match.params.id } // or `todos/${props.todoId}`
    ]),
